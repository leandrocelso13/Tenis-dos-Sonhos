...
<body>
    ...
    <div class="wrapper">
        ...
        <form method="post" id="cadastroForm" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nome" class="form-control" required 
                       minlength="15" maxlength="80" autocomplete="off"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="data_nascimento" class="form-control" required autocomplete="off">
                    </div>
                </div>
                <!-- Sexo -->
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nome_materno" class="form-control" required 
                               autocomplete="off" placeholder="Nome completo da mãe">
                    </div>
                </div>
                <!-- CPF -->
                <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" required 
                       autocomplete="off" placeholder="seu@email.com"
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Número*</label>
                        <input type="text" name="numero" class="form-control" required autocomplete="off">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="complemento" class="form-control" autocomplete="off">
                    </div>
                </div>
                <!-- Bairro -->
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="estado" id="estado" 
                               class="form-control" required maxlength="2" autocomplete="off">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="login" class="form-control" required 
                               minlength="6" maxlength="6" pattern="[A-Za-z]{6}" autocomplete="off"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="password" name="senha" id="senha" 
                               ...
                               minlength="8" maxlength="8" pattern="[A-Za-z]{8}" autocomplete="new-password"
