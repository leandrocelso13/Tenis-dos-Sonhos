    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }    
        ...
        [data-bs-theme="dark"] .col-texto p {
            ...
            text-align: justify !important; /* MANTÉM O JUSTIFICADO IGUAL AO MODO CLARO */
            text-justify: inter-word !important; /* ELIMINA OS BURACOS ENTRE AS PALAVRAS */
        }
...
<div class="container mt-5 mb-5">    
    ...
    <div class="card-sobre-mim shadow-lg">
        ...
        <div class="col-foto">
            <img src="./imagens/leandro.png" alt="Leandro Celso">
        </div>
        
        <!-- Coluna Direita: Texto Sobre Mim -->
        <div class="col-texto">
            <h2>Eu sou Leandro Celso</h2>
            
            <p>
                Aluno da faculdade Unissuam no curso de Análise e Desenvolvimento de Sistemas, disciplina infraestrutura, período 2026 - 1 - manhã, unidade Campo Grande - Rio de Janeiro.
            </p>
            
            <p>
                <strong>Minha missão:</strong> Criar experiências digitais que 
                unam design, funcionalidade e um toque pessoal.
            </p>
            
            <p>
                <i class="fas fa-check-circle text-danger"></i> Desenvolvedor Web
                <br>
                <i class="fas fa-check-circle text-danger"></i> Apaixonado por Design
                <br>
                <i class="fas fa-check-circle text-danger"></i> Sempre aprendendo algo novo
            </p>
        </div>
